                ...
                <ul class="navbar-nav " v-if="$store.state.user.is_login">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu ">
                            <li><router-link
                                    :class="route_name == 'user_bot_index' ? 'dropdown-item active' : 'dropdown-item'"
                                    :to="{ name: 'user_bot_index' }">我的Bot</router-link></li>
                            <li>
                ...
                <ul class="navbar-nav " v-else>
                    ...
                    <li class="nav-item dropdown">
                        <router-link :class="route_name == 'user_account_register' ? 'nav-link active' : 'nav-link'"
                            :to="{ name: 'user_account_register' }" role="button">
                            注册
                        </router-link>
                    </li>
                </ul>
